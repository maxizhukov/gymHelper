...
/**
 * The food tracker. Owns the `food_entries`, `food_daily_targets` and
 * `food_favourites` tables (bootstrapped by FoodService) and turns text or a
 * label photo into editable
